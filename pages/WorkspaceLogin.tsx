...
export const WorkspaceLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-lg border border-gray-800 bg-gray-900/60 p-6 shadow-lg">
        <h1 className="text-xl font-semibold mb-2">Workspace Girişi</h1>
        <p className="text-sm text-gray-400 mb-4">Owner ve Admin erişebilir.</p>
        ...
        <div className="mt-4 text-xs text-gray-500">
          Admin Panel için <Link className="text-emerald-400 underline" to="/hekadmin/login">/hekadmin/login</Link>
        </div>
      </div>
    </div>
  );
